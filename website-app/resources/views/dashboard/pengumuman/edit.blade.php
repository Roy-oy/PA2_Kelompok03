                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="isi_pengumuman" id="isi_pengumuman" rows="5" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 @error('isi_pengumuman') border-red-500 @enderror">{{ old('isi_pengumuman', $pengumuman->isi_pengumuman) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_upload" id="tanggal_upload" 
                            value="{{ old('tanggal_upload', $pengumuman->tanggal_upload->format('Y-m-d')) }}" min="{{ now()->format('Y-m-d') }}" required
