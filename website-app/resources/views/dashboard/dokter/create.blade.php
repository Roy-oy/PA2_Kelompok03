...
<div class="px-4 py-5">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
        ...
        <div class="p-6">
            ...
            @endif
            <form action="{{ route('dokter.store') }}" method="POST" enctype="multipart/form-data" id="create-doctor-form">
                @csrf
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="no_str" name="no_str" value="{{ old('no_str') }}"
                                            ...
                                            placeholder="Masukkan nomor STR (12 digit)" maxlength="12" required>
                                    </div>
                                    @error('no_str')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
...
<script>
    $(document).ready(function() {
        ...
        $('#create-doctor-form').on('submit', function(e) {
